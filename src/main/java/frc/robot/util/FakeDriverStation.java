...
public class FakeDriverStation {

  public enum FakeDriverStationMode {
      TELEOP,
      AUTONOMOUS
  }
  
  private Thread m_thread;
  private FakeDriverStationMode mode;

  public FakeDriverStation(FakeDriverStationMode mode) {
    this.mode = mode;
  }
  private void generateEnabledDsPacket(byte[] data, short sendCount) {
    ...
    data[3] = 0x04; // auto enabled

    if (mode == FakeDriverStationMode.AUTONOMOUS) {
      data[3] |= 0x02; //autonomous mode
    }
